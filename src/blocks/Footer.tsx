...
// Data for social media links, including the SVG components
const socialLinks = [
  {
    href: "#",
    label: "Twitter",
          ...
          <div className="flex items-center gap-6">
            {socialLinks.map((social) => (
              <a
                key={social.label}
                href={social.href}
                className="text-slate-500 hover:text-white hover:scale-110 transform transition-all duration-200"
