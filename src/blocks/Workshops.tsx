  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto text-center">
        ...
        <p className="text-lg text-white py-5 mx-auto mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-white ">
          {sessions.map((s, i) => (
            <a
              key={i}
              href="#"
              className="group text-left p-8 rounded-2xl bg-white/10 backdrop-blur-sm  shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300"
            >
              {/* Card Header */}
              ...
              {/* Footer Link */}
              <div className="inline-flex items-center gap-2 text-indigo-30000 font-semibold transition-all duration-300">
                Register Now
